<%@ page language="java" import="com.ilp.otts.bean.TestBean" contentType="text/html; charset=ISO-8859-1"
...
t=(TestBean)request.getAttribute("updateviewtest");
%>
<table border="2">
<tr>
<td>Test id</td><td>Test Name</td><td>Duration</td><td>Category</td><td>No of Students</td>
</tr>
<tr>
<td><%=t.getTestid() %></td><td><%=t.getTestName() %></td><td><%=t.getDuration() %></td><td><%=t.getCategory() %></td><td><%=t.getNoofStudents() %></td>
</tr>
</table>
<form name=form action="/OTTS/TestController" method="post" onsubmit="return validate();">
<table>
<tr>
<td>New Test name:</td><td><input type=text name=testname></input></td>
</tr>
<tr>
<td>New Test Duration:</td><td><input type=text name=duration></input></td>
</tr>
<tr>
<td>New no of students:</td><td><input type=text name=noofstudents></input></td>
</tr>
</table>
<input type="hidden" name="page" value=updatetest2></input>
