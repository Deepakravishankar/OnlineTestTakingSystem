<%@ page import="com.ilp.otts.bean.TestBean,java.util.ArrayList" language="java" contentType="text/html; charset=ISO-8859-1"
...
<table border=2>
<tr>
<td>testid</td><td>testname</td><td>duration</td><td>category</td><td>no of students</td>
</tr>
<%ArrayList<TestBean> tb=new ArrayList<TestBean>();
tb=(ArrayList<TestBean>)request.getAttribute("testview");
if(tb!=null){
for(int i=0;i<tb.size();i++){
%>
<tr>
<td><%= tb.get(i).getTestid() %></td><td><%= tb.get(i).getTestName()%></td><td><%=tb.get(i).getDuration() %></td>
<td><%=tb.get(i).getCategory() %></td><td><%=tb.get(i).getNoofStudents() %></td>
</tr>
<%}} %>

</table>
<button name="home" value="HOME" onClick="window.open('/OTTS/jsp/Success.jsp','_self','');">home</button>
