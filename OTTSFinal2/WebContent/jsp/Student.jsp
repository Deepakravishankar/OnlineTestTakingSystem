...
<form name="myform" method="post" action="/OTTS/TestController">
<input type="hidden" name="page" value="viewteststudent1">
<input type="hidden" name="studentid" value="1"></input>
<br><br><br><br>
<center><input type="submit" value="ViewTest" ></input></center>
</form>
