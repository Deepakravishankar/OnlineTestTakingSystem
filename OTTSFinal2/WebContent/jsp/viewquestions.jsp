...
<%@ page import="com.ilp.otts.bean.QuestionBean"%>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
ArrayList<com.ilp.otts.bean.QuestionBean> obj1=new ArrayList<com.ilp.otts.bean.QuestionBean>(); 
obj1=(ArrayList<com.ilp.otts.bean.QuestionBean>)request.getAttribute("s");%>
<tr>
<td>QUESTIONID</td><td>QUESTION</td><td>CATEGORY</td><td>OPTION1</td><td>OPTION2</td><td>OPTION3</td><td>OPTION4</td><td>ANSWER</td></tr>
<%for(int i=0;i<obj1.size();i++){

%>

<tr><td><%=obj1.get(i).getQuestionid()%></td><td><%=obj1.get(i).getQuestion()%></td><td><%= obj1.get(i).getCategory()%></td>
<td><%=obj1.get(i).getOption1() %></td><td><%=obj1.get(i).getOption2() %></td><td><%=obj1.get(i).getOption3() %></td>
<td><%=obj1.get(i).getOption4() %></td><td><%=obj1.get(i).getAnswer() %></td>
</tr>
<%} %>
