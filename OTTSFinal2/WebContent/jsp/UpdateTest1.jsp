...
function validate()
{
	var x=document.forms["form"]["testid"].value;
	if (x==null || x=="")
	  {
...
<label>Enter testid</label>
<input type="text" name=testid ></input>
<input type="hidden" name="page" value="updatetest1"></input>
<input type=submit value="update"></input>
<label>(OR)</label>
<br></br>
<a href="/OTTS/TestController?page=updatetestview">CLICK HERE TO SELECT FROM AVAILABLE TESTS</a>
</form>
