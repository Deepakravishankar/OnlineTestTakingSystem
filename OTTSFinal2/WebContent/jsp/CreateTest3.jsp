...
<div>
<h2>CREATE TEST3</h2>
<%ArrayList<TestQuestionBean> ttb=new ArrayList<TestQuestionBean>();
String testid=(String)session.getAttribute("ctt");
ttb=(ArrayList<TestQuestionBean>)session.getAttribute("tqb");
...
<input type="checkbox" name="testquestion" value="<%= ttb.get(i).getQuestionid()%>"><%=ttb.get(i).getQuestionName() %><br>
<%} %>
<input type="hidden" name="page" value="createtest3"></input>
