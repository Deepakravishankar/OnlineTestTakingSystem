...
<h1 align="center"> Assigned Tests</h1>
<% ArrayList<String> list= (ArrayList<String>)session.getAttribute("testassigned");
	for(String testid: list){
%>
<a href="/OTTS/TestController?page=starttest&testid=<%=testid%>"><%=testid%></a>
<br>
<%} %>
