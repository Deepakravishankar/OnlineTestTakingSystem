...
<html lang="en">
  ...
  function validate()
{
	var x=document.forms["form2"]["id"].value;
if (x==null || x=="")
{
...
if(isNaN(x))
{
	//alert("Please enter a number for TestId ");
	return true;
}
...
<div id="content" style="height:200px;width:350px;float:left;">
<h2 align="center"> Delete Test</h2>
<form name="form2" method="post" action="<%=request.getContextPath()%>/TestController" onsubmit="return validate();">
Enter the TestId: <input type="text" name="id"><br><br>
<input type="hidden" name="page" value="deletetest"></input>
