<%@ page language="java" import="com.ilp.otts.bean.TestQuestionBean, java.util.ArrayList"contentType="text/html; charset=ISO-8859-1"
...
function validate()
{
var chks = document.getElementsByName('testquestion[]');
        ...
        <div class="span2">
          <div class="well sidebar-nav">
            ...
            <!-- Side bar links placed here  -->
				<%@ include file="/CRUDlinks/TestCrudLinks.jsp"%>    
				  <!-- Side bar links placed here  -->
...
<h1>Update Questions associated with Test</h1>
<%ArrayList<String> t1=new ArrayList<String>();
ArrayList<TestQuestionBean> t2=new ArrayList<TestQuestionBean>();
t1=(ArrayList<String>)request.getAttribute("selectedquestion");
t2=(ArrayList<TestQuestionBean>)request.getAttribute("allquestion");
%>
<form action="/OTTS/TestController" method="post" onsubmit="return validate();">
<% if(t2!=null&&t1!=null){
	for(int i=0;i<t2.size();i++){
		
		if(t1.contains(t2.get(i).getQuestionid())){%>
<input type="checkbox" name="testquestion" value="<%=t2.get(i).getQuestionid() %>" checked><%=t2.get(i).getQuestionName() %><br></br>
		<% }
		else{%>
			<input type="checkbox" name="testquestion" value="<%=t2.get(i).getQuestionid() %>" ><%=t2.get(i).getQuestionName() %><br></br>
		<%}
...
%><br></br>
<input type="hidden" name="page" value="updatetestquestion"></input>
