    ...
    <%@ page language="java" import="java.util.ArrayList, com.ilp.otts.bean.TestTeacherBean" contentType="text/html; charset=ISO-8859-1"    pageEncoding="ISO-8859-1"%>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
ttb=(ArrayList<TestTeacherBean>)session.getAttribute("ttb");
%>
<form name="form" action="/OTTS/TestController" method="post" onsubmit="return validate();">
<%for(int i=0;i<ttb.size();i++){ %>
<input type="checkbox" name="testteacher" value=<%=ttb.get(i).getTeacherid() %>><%=ttb.get(i).getTeacherName()%><br></br>
<%} %>
<input type="hidden" name="page" value="createtest2"></input>
