...
<html lang="en">
  ...
  function validate()
{
var x=document.forms["form1"]["QuestionId"].value;
if (x==null || x=="")
  {
  alert("Please enter the Questionid");
  return false;
  }
return true;
}
...
<form name="form1" method="post" action="<%=request.getContextPath()%>/QuestionController" onsubmit="return validate()" >
<input type="hidden" name="page" value="delete">
<h2>Delete Question</h2>
QuestionId:
<input type="text" name="QuestionId" value=""></input>
<p><input type="submit" value="Delete" name="register" class="button"></input>
<input type="reset" value="reset"></input>
<input type="submit" value="Cancel" name="cancel" class="button"></input>
