...
<div id="content" style="height:200px;width:600px;float:left;">
...
<input type="hidden" name="answer" id="answers" ></input>
<h2>Update Question</h2>
<label>QuestionId</label>
 <input type="text" value="" name=QuestionId></input>
<p><label>Question</label> 
<input type="text" name="Question"	value=""></input></p>
...
<label>Option1</label>
<input type="text" value="" name="Option1" id="Option1" ></input>
<label>Option2</label>
<input type="text" value="" name="Option2" id="Option2"></input><br>
<label>Option3</label>
<input type="text" value="" name="Option3" id="Option3"></input>
<label>Option4</label>
<input type="text" value="" name="Option4" id="Option4"></input><br>

<label>Answer:</label>
<select id="Answer1" onchange ="validate();">
<option value=""></option>
