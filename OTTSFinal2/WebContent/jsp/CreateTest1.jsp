...
var x=document.forms["form1"]["tname"].value;
if (x==null || x=="")
  {
  alert("Please enter the Testname");
  return false;
  }
if(isNaN(document.form1.dur.value))
{
	alert("enter  a number for duration of test");
	return false;
}

var x=document.forms["form1"]["dur"].value;
if (x==null || x=="")
  {
  alert("Please enter the Duration");
  return false;
  }
if(isNaN(document.form1.noofstud.value))
{
	alert("enter number as input for no of students");
	return false;
}
var x=document.forms["form1"]["noofstud"].value;
if (x==null || x=="")
  {
...
<div>
<form name="form1" action="/OTTS/TestController" method="post" onSubmit="return validate();">
<h2>CREATE TEST STEP1</h2>
<table border="2">
<tr>
<td>Enter Test Name:</td>
<td><input type="text" name="tname"></input></td>
</tr><tr><td>Enter Duration of Test in minutes:</td>
<td><input type="text" name="dur"></input></td>
</tr><tr><td>Enter No Of Students:</td>
<td><input type="text" name="noofstud"></input></td>
</tr><tr><td>Select Category:</td>
...
<br></br>
<input type="hidden" name="page" value="createtest1">
