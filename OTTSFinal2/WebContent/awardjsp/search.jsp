...
<div class="span6">
	...
	<center>
<h4 style="font-family:gentiumbasic;font-size:30px">Allocate Student Award</h4><br></br>

<form name="f1" method="post" action="<%=request.getContextPath() %>/Controller">

<input type="hidden" name="page" value="listaward"><br>
<input type="submit" class="btn btn-primary" name="Allocate" value="Student award allocation">
</center>
</form>
