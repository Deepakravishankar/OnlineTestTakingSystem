...
var x=document.forms["school"]["schoolid"].value;
if (x==null || x=="")
  {
...
return confirm("Are you sure, you want to delete the allocated School award?");
}
</script>
...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px">Delete School Award</h4><br></br>

<form name="school" method="post" onsubmit="return validateForm()" action="<%=request.getContextPath()%>/Controller">

<input type="hidden" name="page" value="deleteschoolaward">
			Enter School Id:
			<input type="text" name="schoolid"/><br><br></br>
