        ...
        <div class="span2">
          <div class="well sidebar-nav">
            ...
            <!-- Side bar links placed here  -->
				<%@ include file="/CRUDlinks/SchoolAwardCrudLinks.jsp"%>    
				  <!-- Side bar links placed here  -->
...
<h4 style="font-family:gentiumbasic;color:maroon;font-size:30px;position:relative;left:-1px">Update Allocated School Award </h4>
...
<br><br>
<center>
<input type="hidden" name="page" value="updateschool"></input>
