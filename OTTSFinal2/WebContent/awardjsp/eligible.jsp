...
<h4 style="font-family:gentiumbasic;color:maroon;font-size:30px">View Eligible Students</h4>

<center>
<form name="f2" method="post" action="<%=request.getContextPath()%>/Controller">
<input type="hidden" name="page" value="Eligible"></input>
<input type="submit" value="View Eligible Students" name="page"></form>
</center>
