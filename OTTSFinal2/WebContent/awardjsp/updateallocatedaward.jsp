...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px">Update Allocated Student Award</h4><br><br>

<form name="f1" method="post" action="<%=request.getContextPath()%>/Controller">

<input type="hidden" name="page" value="viewupdate"></input>

Enter Award ID : <input type="text" name="awardid"></input><br><br>
