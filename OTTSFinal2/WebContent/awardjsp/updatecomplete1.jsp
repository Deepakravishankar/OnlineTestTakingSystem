...
<h4 style="font-family:gentiumbasic;font-size:30px;">View Award Details</h4><br></br>



<% 
		ArrayList<Bean> viewresult = (ArrayList<Bean>)(request.getAttribute("viewresult"));
            ...
            for(int i=0; i<viewresult.size(); i++) {
            	...
            	System.out.println("Award ID: " + view.getAwardid());
            	System.out.println("Award type: " +view.getAwardtype());
            	System.out.println("Award Name: " + view.getAwardname());
            	System.out.println("Award amount: " + view.getAwardamount());
            	System.out.println("Award reason: " + view.getAwardreason());
            	System.out.println("Award details: " + view.getAwarddetails());
          //  	System.out.println("Avg score: " + view.getAvg());
