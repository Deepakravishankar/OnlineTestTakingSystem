...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px">Update Allocated School Award</h4><br></br>

<form name="f1" method="post" action="<%=request.getContextPath()%>/Controller">

<input type="hidden"   name="page" value="viewschoolupdate"></input><br>

Enter Award ID : <input type="text" name="awardid"></input><br>
