...
{
	var x=document.forms["myForm"]["awardid"].value;
if (x==null || x=="")
  {
  alert("Award ID must be selected");
  return false;
  }
return true;
}
...
function cancelAction() 
{
    ...
    if (cancel==true)
    {
    	document.location.href("welcomeadmin.jsp"); 
...
<h4 style="font-family:gentiumbasic;font-size:30px;">Update Award Details</h4><br></br>

<form name="myForm" method="post" action= " <%=request.getContextPath()%>/Controller" onsubmit="return validateForm()">
<input type="hidden" name="page" value="viewone" >
<table style="position:relative;left:-80px"><tr><td>
Enter Award Id : </td><td><input type="text" name="awardid" >
</td></tr>
<tr><td></td><td>
<br>
<input type="submit" class="btn btn-primary" value="Update" name="submit" style="position:relative;left:-60px"></td></tr>
