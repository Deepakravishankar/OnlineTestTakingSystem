<%@ page import="com.ilp.otts.bean.Bean" import="java.util.*" language="java" contentType="text/html; charset=ISO-8859-1"
...
<h4 style="font-family:gentiumbasic;color:maroon;font-size:30px;position:relative;left:-1px"></h4>

<center>
<h3>The school award details are</h3>
<table border=1 style="position:relative;left:-1px">
...
<tr>
<td><%=obj.getTestid() %></td>
<td><%=obj.getAwardid() %></td>
<td><%=obj.getSchoolid() %></td>
<td><%=obj.getAwardname() %></td>
</tr>
<% } %>
</table>
</center>
