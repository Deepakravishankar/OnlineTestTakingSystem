...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px">Display Eligible schools</h4>



<form name="f2" method="post" action="<%=request.getContextPath()%>/Controller">

<input type="hidden" class="btn btn-primary" name="page" value="display" ><br></br>
<input type="submit" class="btn btn-primary" name="page" value="Display Eligible Schools">
