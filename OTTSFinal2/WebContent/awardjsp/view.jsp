...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px;">View Award</h4><br></br>
<form name="myForm" method="post" action="<%=request.getContextPath()%>/Controller">
<input type="hidden" name="page" value="viewaward"> <br><br>
<p><input type="submit" class="btn btn-primary" value="View Award Details" name="view" class="button"><br><br>
