...
{
var x=document.forms["award"]["awardid"].value;
if (x==null || x=="")
  {
  alert("Enter valid AwardID");
  return false;
  }
	

var y=document.forms["award"]["reason"].value;
if (y==null || y=="")
  {
  alert("Enter Reason for deletion");
  return false;
  }
return confirm("Are you sure, you want to delete the Award?");
}
...
<h4 style="font-family:gentiumbasic;font-size:30px">Award Deletion</h4><br></br>




<form name="award" method="post" onsubmit="return validateForm()" action="<%=request.getContextPath()%>/Controller">
<table style="position:relative;left:-80px">
		<tr><td align="left">Enter AwardId</td><td>
			<input type="text" name="awardid"/></td></tr>
			<tr><td>Reason for deletion</td>
			<td><input type="text" name="reason"/></td></tr>
			<tr><td></td><td><center><input type="submit" class="btn btn-danger" name="page" value="Delete"></center></td></tr>			
