...
function validateForm()
{
	...
	return confirm("Are you sure, you want to delete the allocated Award?");
}
</script>
    <!-- Le styles -->
...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px">Student Award Deletion</h4><br></br>


<form name="f1" method="post" action="<%=request.getContextPath()%>/Controller" onsubmit="return validateForm()">
Enter the student id
<input type="text" name="studentid" id="studentid" style="left:-70px"></input><br></br>
<input type="hidden" name="page" value="Deleteaward">
<input type="submit" class="btn btn-danger" value="Delete" name="page"></input>
</form>
