...
<div class="span6">
	...
	<center>
<h4 style="font-family:gentiumbasic;font-size:30px">View Allocated Student Awards</h4>

<form name="f1" method="post" action="<%=request.getContextPath()%>/Controller">

<input type="hidden" name="page" value="viewallocatedaward"><br></br>

<input type="submit" class="btn btn-primary" value="view" name="Allocated Awards" >
