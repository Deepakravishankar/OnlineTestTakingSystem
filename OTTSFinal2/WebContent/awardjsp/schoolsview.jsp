...
<h4 style="font-family:gentiumbasic;color:maroon;font-size:30px"">Allocate School Awards</h4>

<form action="<%=request.getContextPath()%>/Controller" method="post">
<input type="hidden" name="page" value="allocateschools">
<table border="1">
<% ArrayList<Bean> rblist=(ArrayList<Bean>)request.getAttribute("viewschools"); 
if(rblist!=null){
	if(!rblist.isEmpty()){
%>

		<tr><td>Eligible Schools </td></tr>
		<tr>
		<td>School Id</td>
...
<tr>
<td><input type="checkbox" name="id" value="<%=rb.getSchoolid()%>"><%=rb.getSchoolid()%> </td>
...
<%
		...
		out.println("No Eligible Schools found");
