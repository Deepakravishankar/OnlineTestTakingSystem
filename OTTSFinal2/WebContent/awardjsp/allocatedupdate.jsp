<%@ page language="java" import="com.ilp.otts.bean.Bean,java.util.ArrayList" contentType="text/html; charset=ISO-8859-1"
...
<h4 style="font-family:gentiumbasic;color:maroon;font-size:30px;position:relative;left:-1px">Update Allocated Student Award</h4>
<form name="f1" method="post" action="<%=request.getContextPath()%>/Controller" >
<%ArrayList<Bean> list=(ArrayList<Bean>)(request.getAttribute("result")); %>

<center>
<table border="1">

<%for(Bean obj:list){ %>
<tr><td>Test ID : <input type="text" name="testid" value="<%= obj.getTestid()%>"></input> </td></tr>
<tr><td>Student ID : <input type="text" name="studentid" value="<%= obj.getStudentid()%>"></input> </td></tr>
<tr><td>Award ID:<input type="text" name="awardid" value="<%= obj.getAwardid()%>" readonly ></input></td></tr>
<tr><td>School ID : <input type="text" name="schoolid" value="<%= obj.getSchoolid()%>"></input></td></tr>
<tr><td>Award Name : <input type="text" name="awardname" value="<%= obj.getAwardname()%>"></input> </td></tr>
<%} %>
...
<center>
<input type="hidden" name="page" value="updatestudent"></input>
