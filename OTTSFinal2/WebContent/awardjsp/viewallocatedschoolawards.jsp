...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px">View Allocated School Awards</h4>
<br></br>

<form name="f1" method="post" action="<%=request.getContextPath() %>/Controller">

<input type="hidden" name="page" value="viewschoolaward">
<input type="submit" class="btn btn-primary" name="View" value="View School Award Details"><br></br>


<a class="btn btn-primary" onclick="window.open('<%=request.getContextPath()%>/Controller?page=pdfgen')">Generate PDF</a>
</center>
</form>
