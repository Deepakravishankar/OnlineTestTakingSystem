        ...
        <div class="span2">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
				<li><a class="active" href="/OTTS/WelcomeJSP/<%=session.getAttribute("role")%>.jsp" >Home</a><br><br></li>           
            </ul>
          </div><!--/.well -->
        </div><!--/span-->
...
<div class="span6">
	...
	%>
	<form action="/OTTS/ManageTeacherServlet" method="post" onsubmit="return validate(this)">
		<input id="type" type="hidden" name="type" value="update-profile"> <input
			type="hidden" name="id" value=<%=teacherBean.getId() %>>
		<table>
			<tr>
				<td>FirstName:</td>
				<td><input type="text" name="firstname"
					value=<%=teacherBean.getFirstname()%> disabled="true"></input></td>
			</tr>
			<tr>
				<td>MiddleName:(optional)</td>
				<td><input type="text" name="middlename"
					value=<%=teacherBean.getMiddlename()%> disabled="true"></td>
			</tr>
			<tr>
				<td>LastName:</td>
				<td><input type="text" name="lastname"
					value=<%=teacherBean.getLastname()%> disabled="true"></td>
			</tr>
			<tr>
				<td>DOB:</td>
				<td><input type="text" name="dob" value=<%=teacherBean.getDob()%> disabled="true">
				</td>
			</tr>
			<tr>
				<td>Email:</td>
				<td><input type="text" name="email"
					value=<%=teacherBean.getEmail()%> id="email" onblur="check(this)"></td>
					<td id="email-error" class="error"></td>
			</tr>
			<tr>
				<td>PhoneNumber:</td>
				<td><input type="text" name="phonenumber"
					value=<%=teacherBean.getPhonenumber()%> id="phonenumber" onblur="check(this)"></td>
					<td id="phonenumber-error" class="error"></td>
			</tr>
			<tr>
				<td>Address:</td>
				<td><input type="text" name="address"
					value=<%=teacherBean.getAddress()%> disabled="true"></td>
			</tr>

			<tr align="center">
				<td colspan="2"><input id="submit" type="submit" name="submit"
					value="Update"></td>
			</tr>
		...
		<form action="/OTTS/ManageTeacherServlet" method="post">
	<input type="hidden" name="type" value="update-profile-secretquestion">
		<table>
			...
			<tr><td></td><td> <input type="submit" value="Set" style="width:100px"> </td></tr>
		</table>
	</form>
	<%
		} else {
