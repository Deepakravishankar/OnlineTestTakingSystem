 ...
 <!-- <img alt="not avail" src="/OTTS/grey.jpg">  -->
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            <p class="navbar-text pull-right">
              <a class="navbar-link" href="/OTTS/WelcomeJSP/Login.jsp">Login</a> 
            </p>
            <ul class="nav">
    ...
    <!--/sidebar-->
        ...
        <!--    <div class="well sidebar-nav">
			...
			Side bar links are placed here
...
<form action="/OTTS/ChangePassword" method="post">
<input type="hidden" value="get-secret-question" name="page">
<table>
	<tr>
		<td>
		Enter Your Username:
		...
		<td>
		<input class="btn btn-info" type="submit" value="Get Secret Question">
		</td>
...
<% String question=(String)request.getAttribute("secret-question");
	String usernameError=(String)request.getAttribute("username-error");
	if(usernameError!=null)
		out.println("Username not found try again");
	if(question!=null){
%>
<form method="post" action="/OTTS/ChangePassword">
<input type="hidden" value="check-secret-answer" name="page">
...
<% String answermismatch=(String)request.getAttribute("answer-mismatch");
	if(answermismatch!=null)
		out.println(answermismatch);
	String status=(String)request.getAttribute("status");
	if(status!=null){
		
		if(status.equals("Success"))
			out.println("Password Change Succeded, New Password: "+(String)request.getAttribute("newpwd"));
		else
