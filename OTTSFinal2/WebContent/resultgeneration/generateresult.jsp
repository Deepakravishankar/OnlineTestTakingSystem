<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="java.sql.*,com.ilp.otts.db.*" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
{
var x=document.forms["create"]["testid"].value;
if (x==null || x=="")
  {
  alert("Test id must be filled");
  return false;
  }
if(x==-1)
{
	alert("Select the test id");
	return false;}
return true;
}
...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px;position:relative;left:-10px">Generate Result</h4><br></br>


<form name="create" method="post" action="<%=request.getContextPath()%>/Controller" onsubmit="return validateForm()">

<input type="hidden" name="page" value="GenerateResult">
<table><tr><td align="left" style="position:relative;left:-10px">Test Id: </td><td>

<%  
Class.forName("oracle.jdbc.driver.OracleDriver");
//Connection con = DriverManager.getConnection("jdbc:oracle:thin:@172.24.137.30:1521:ora10g", "e584488","ZtWnkhpIb");
Connection con=DBConnection.getConnection();
Statement stmt = con.createStatement();
ResultSet rs = stmt.executeQuery("select distinct testid from teststudent"); %>

<select name="testid" align="left" style="position:relative;left:-10px">
...
<tr><td></td><td><br><input type="submit" class="btn btn-primary" value="GenerateResult" name="submit" style="position:relative;left:-70px"></input></td></tr>
</table>
</center>
</form>
