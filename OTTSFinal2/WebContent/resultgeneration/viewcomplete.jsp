...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px;position:relative;left:-1px">Student Results</h4><br></br>
...
<% 
		ArrayList<Bean> viewresult = (ArrayList<Bean>)(request.getAttribute("viewresult"));
            ...
            for(int i=0; i<viewresult.size(); i++) {
            	...
            	System.out.println("School ID: " + view.getSchoolid());
...
%>
         ...
         <table border=1 style="position:relative;left:-100px">
         <tr>
