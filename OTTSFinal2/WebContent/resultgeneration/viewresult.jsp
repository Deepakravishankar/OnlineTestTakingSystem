...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px;position:relative;left:-1px">Click to view the Results</h4>



<form name="f2" method="post" action="<%=request.getContextPath()%>/Controller" onsubmit="return validateForm()">
<input type="hidden" name="page" value="viewresult"></input>
<br></br>
<input type="submit" style="position:relative;left:-40px" class="btn btn-primary" name="submit" value="View Results"></input>
</form>

<br>


<a class="btn btn-primary" onclick="window.open('<%=request.getContextPath()%>/Controller?page=pdfgenerate')">Generate PDF</a>
