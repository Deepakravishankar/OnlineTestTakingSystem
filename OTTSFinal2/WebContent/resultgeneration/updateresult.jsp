...
var y=document.forms["f2"]["studentid"].value;
if (y==null || y=="")
  {
...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px;position:relative;left:-1px">Update Results</h4><br></br>



<form name="f2" method="post" action="<%=request.getContextPath()%>/Controller" onsubmit="return validateForm()">
<input type="hidden" name="page" value="updateresult"></input>
<table>
<tr><td align="left" style="position:relative;left:-60px">Test Id:   &nbsp &nbsp &nbsp<input type="text" name="testid" ></input><br></br></td></tr>
<tr><td align="left" style="position:relative;left:-60px">Student Id:&nbsp<input type="text" name="studentid" ><br></br></td></tr>
<tr><td>&nbsp &nbsp<input class="btn btn-primary" type="submit" name="submit" value="Update"></td></tr>
</table></center>
</form>
