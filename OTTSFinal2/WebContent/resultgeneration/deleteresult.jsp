...
{
var x=document.forms["f2"]["testid"].value;
if (x==null || x=="")
  {
...
var x=document.forms["f2"]["studentid"].value;
if (x==null || x=="")
  {
...
return confirm("Do you want to delete the result?");
}
...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px;position:relative;left:10px">Delete Result</h4><br></br>

<form name="f2" method="post" action="<%=request.getContextPath()%>/Controller"  onsubmit="return validateForm()">
<input type="hidden"  name="page" value="deleteresult"></input>

<table>
<tr><td align="left" style="position:relative;left:-60px">Test id:</td><td><input type="text" name="testid" style="position:relative;left:-60px"></input></td></tr>
<tr><td align="left" style="position:relative;left:-60px">Student id</td><td><input type="text" name="studentid" style="position:relative;left:-60px"></td></tr>
<tr><td></td><td><input type="submit" class="btn btn-danger" name="submit" value="Delete" style="position:relative;left:-90px"></td></tr>
</table>
</center>
</form>
