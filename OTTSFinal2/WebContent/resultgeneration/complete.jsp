...
<%@ page import="java.sql.*" import="com.ilp.otts.bean.Bean"%>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
{
var x=document.forms["f1"]["testid"].value;
var y=document.forms["f1"]["studentid"].value;
if (x==null || x=="")
  {
  alert("Testid must be filled out");
  return false;
  }
var x=document.forms["f1"]["studentid"].value;
if (x==null || x=="")
  {
...
if(y==-1)
{
	alert("Select a valid student id");
	return false;}
var x=document.forms["f1"]["schoolid"].value;
if (x==null || x=="")
  {
  alert("Schoolid must be filled out");
  return false;
  }
return true;
}  
        ...
        <div class="span2">
          <div class="well sidebar-nav">
            ...
            <!-- Side bar links placed here  -->
				<%@ include file="/CRUDlinks/ResultCrudLinks.jsp"%>    
				  <!-- Side bar links placed here  -->
...
<center>
<h4 style="font-family:gentiumbasic;font-size:30px;position:relative;left:-10px">Generate Results</h4><br></br>
...
<% 
		ArrayList<Bean> awardList = (ArrayList<Bean>)(request.getAttribute("awardList"));
			
            
            
            for(int i=0; i<awardList.size(); i++) {
            	Bean award = awardList.get(i);
            	System.out.println("Student ID: " + award.getStudentid());
 ...
 %>
  ...
  <%=  award.getStudentid() %><br></br>
   ...
   %> </center>
          ...
          -->
         <form name="f1" method="post" action="<%=request.getContextPath()%>/Controller"  onsubmit="return validateForm()" >
         <center>
         <table style="position:relative;left:-90px"><tr><td align="left">Test ID : </td><td><input type="text" name="testid" value="<%=testid %>"></input></td></tr>
        <tr><td align="left">Select Student ID : </td><td>
...
<option value="<%=award.getStudentid() %>"><%=award.getStudentid() %></option>
<%}%>
</select>
</td></tr><tr>
<td align="left">Enter The School ID :</td><td><input type="text" name="schoolid"></input></td>
</tr>
         <input type="hidden" name="page" value="StudentResult">
         
         </table>
         </center>
         
         <center><input type="submit" class="btn btn-info" name="submit" value="Generate" style="position:relative;left:-80px"></center>
         </form>
