<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="java.util.ArrayList" import="com.ilp.otts.bean.*" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
function validate(){
	x=document.myforms.update.testid.value;
	if(x.length>20)
	{
...
<h4 style="font-family:gentiumbasic;color:maroon;font-size:30px;position:relative;left:-1px">Update Results</h4>

<% 
		ArrayList<Bean> viewresult = (ArrayList<Bean>)(request.getAttribute("updateresult"));
            ...
            for(int i=0; i<viewresult.size(); i++) {
            	...
            	System.out.println("Test ID: " + view.getTestid());
...
%>
         ...
         <form name="update" method="post" action="<%=request.getContextPath()%>/Controller" onsubmit="return validate()">
        <center> <table border=1 style="position:relative;left:-60px">
 <% 
 for(int i=0; i<viewresult.size(); i++) {
	 Bean view = viewresult.get(i);
 %>
         ...
         <tr>
         <td>
         Test id</td><td><input type="text" name="testid"  value="<%=  view.getTestid() %>"></input>
         </td></tr>
        <tr> <td>
           Student id</td><td> <input type="text" name="studentid"  value="<%=  view.getStudentid() %>"></input><br></br>
         </td></tr>
         <tr><td>
        Score</td><td><input type="text" name="score" value="<%=  view.getScore() %>"></input><br></br>
         </td>
         </tr>
         <tr><td>
        Percentage</td><td><input type="text" name="avg" value="<%=  view.getAverage() %>"></input><br></br>
         </td>
         </tr>
         <tr>
         <td></td>
        <td><br><input type="submit" name="page" value="StoreUpdate"></input></td></tr>
             <% 
     } 
   %>
         </table>
