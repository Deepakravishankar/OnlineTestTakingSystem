  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/OTTS/bootstrap/docs/assets/css/bootstrap.css">
     <link rel="stylesheet" type="text/css" href="/OTTS/bootstrap/docs/assets/css/bootstrap-responsive.css">
      <link rel="StyleSheet" type="text/css" href="/OTTS/bootstrap/docs/assets/css/datepicker.css"/>
...
<div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="12-02-2012" id="dpYears" class="input-append date">
	<input type="text" readonly="" value="12-02-2012" size="16" class="span10">
  ...
  <div id="footer" class="avbar navbar-fixed-bottom">
	...
	<script src="/OTTS/bootstrap/docs/assets/js/bootstrap-datepicker.js"></script>  
