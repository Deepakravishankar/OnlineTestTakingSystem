...
<a class="btn btn-info" href="/OTTS/ManageStudentServlet?type=view&id=viewall">View All Students >></a>&nbsp

<a onclick="window.open('/OTTS/ManageStudentServlet?type=view&id=viewall-pdf')">Save As Pdf</a>

<br>
<br>
View Student of specific ID
<form name="viewform" action="/OTTS/ManageStudentServlet" onsubmit="return validateId(this)">
<input type="hidden" name="type" value="view">
ID:<input type="text" name="id" id="id">
<input class="btn btn-info" type="submit" value="View Student"><br>
...
%>
	...
	<td><%=studentBean.getMiddlename() %></td>
	<td><%=studentBean.getLastname() %></td>
	<td><%=studentBean.getDob().substring(0,10) %></td>
	<td><%=studentBean.getGender() %></td>
	<td><%=studentBean.getEmail() %></td>
	<td><%=studentBean.getPhonenumber() %></td>
	<td><%=studentBean.getAddress() %></td>
