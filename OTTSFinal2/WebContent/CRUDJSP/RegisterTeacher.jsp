...
<%} %>
	...
	<form name="register" id="register" action="/OTTS/ManageTeacherServlet" method="post" onsubmit="return validate(this)">
		...
		<table>
			...
			<tr align="center">
				<td colspan="2"><input style="width:150px" class="btn btn-primary" type="submit" name="submit" value="Register Teacher">&nbsp
				&nbsp<input type="reset" name="reset" style="width:150px" class="btn">
				</td>
			</tr>
