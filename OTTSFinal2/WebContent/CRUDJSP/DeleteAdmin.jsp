...
<div class="span6">
Enter the User ID to delete the Admin<br></br>
<form action="/OTTS/ManageAdminServlet" method="post" onsubmit="return validateDeleteId(this)">
