...
<a class="btn btn-info" href="/OTTS/ManageSchoolServlet?type=view&id=viewall">View All Schools >></a>&nbsp

<a onclick="window.open('/OTTS/ManageSchoolServlet?type=view&id=viewall-pdf')">Save As Pdf</a>
<br>
<br>
View School of specific ID<br></br>
<form name="viewform" action="/OTTS/ManageSchoolServlet" onsubmit="return validateId(this)">
<input type="hidden" name="type" value="view">
School ID:<input type="text" name="id" id="id">
<input class="btn btn-info" type="submit" value="View School"><br>
...
<% 	ArrayList<SchoolBean> list=(ArrayList<SchoolBean>)request.getAttribute("result");%>
...
%>
	<table border="1">
	<tr>
	<td>School ID</td><td>School Name</td><td>Location</td><td>PhoneNumber</td>
	<td>Board</td><td>Email</td>
	</tr>
...
%>
	<tr>
	<td><%=sb.getSchoolid() %></td><td><%=sb.getName() %></td><td><%=sb.getLocation() %></td><td><%=sb.getPhone() %></td>
	<td><%= sb.getBoard() %></td><td><%= sb.getEmail() %></td>
	</tr>
<% } %>
	</table>
<%	}
...
%>
  ...
  <div id="footer" class="avbar navbar-fixed-bottom">
    ...
    <script type="text/javascript" src="/OTTS/bootstrap/js/bootstrap.js"></script>
