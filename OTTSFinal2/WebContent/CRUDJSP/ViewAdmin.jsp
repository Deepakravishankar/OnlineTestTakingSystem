...
<a class="btn btn-info" href="/OTTS/ManageAdminServlet?type=view&id=viewall">View All Admins >></a>&nbsp
<a onclick="window.open('/OTTS/ManageAdminServlet?type=view&id=viewall-pdf')">Save As Pdf</a>
<br><br>
(OR)
<br><br>
View Admin of specific ID
<form name="viewform" action="/OTTS/ManageAdminServlet" onsubmit="return validateId(this)">
<input type="hidden" name="type" value="view">
ID:<input type="text" name="id" id="id">
<input class="btn btn-info" type="submit" value="View Admins"><br>
...
%>
	<tr>
	<td><%=adminBean.getId() %></td><td><%=adminBean.getFirstname() %></td><td><%=adminBean.getMiddlename() %></td><td><%=adminBean.getLastname() %></td>
	<td><%=adminBean.getDob().substring(0,10) %></td><td><%=adminBean.getEmail() %></td><td><%=adminBean.getPhonenumber() %></td><td><%=adminBean.getAddress() %></td>
	</tr>
<% } %>
	</table>
<%	}
