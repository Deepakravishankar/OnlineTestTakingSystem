...
<div class="span6">
	...
	Enter ID Admin of to Update
	<form action="/OTTS/ManageAdminServlet" onsubmit="return validateId(this)">
		<input type="hidden" name="type" value="getupdate"> ID:
		<input type="text" name="id" id="id"> 
		<input  class="btn btn-info" type="submit" value="Get Admin Details">
