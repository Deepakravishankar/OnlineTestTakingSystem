...
<div class="span6">
	...
	Enter Teacher ID to Update<br></br>
	<form action="/OTTS/ManageTeacherServlet" onsubmit="return validateId(this)">
		<input type="hidden"  id="type" name="type" value="getupdate">
		 Teacher ID:<input  type="text" name="id" id="id"> <input class="btn btn-primary" type="submit" value="Get Teacher Details">
  ...
  <strong>Error!</strong>
	...
	<form action="/OTTS/ManageTeacherServlet" method="post" onsubmit="return validate(this)">
		...
		<table>
			...
			<tr align="center">
				<td colspan="2"><input class="btn btn-success" id="submit" type="submit" name="submit"	value="Update Teacher"></td>
			</tr>
