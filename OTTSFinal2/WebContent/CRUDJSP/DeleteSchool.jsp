...
Enter the ID to delete the School <br><br>
<form action="/OTTS/ManageSchoolServlet" method="post" onsubmit="return validateDeleteId(this)">
<input type="hidden" name="type" value="delete">

<tabel>
<tr>
<td>School ID:</td>
<td><input class="span4" type="text" name="id" id="id"></td>
<td><input type="submit" class="btn btn-danger" value="Delete School"></td>
</tr>
</tabel>
