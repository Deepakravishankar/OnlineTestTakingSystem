        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            <p class="navbar-text pull-right">
              Logged in as <a class="navbar-link" href="/OTTS/MainController?page=profilepage"><%= session.getAttribute("name") %>
               &nbsp
            ...
            <ul class="nav">
              ...
              <li><a class="navbar-link" href="/OTTS/MainController?page=profilepage">Profile</a></li>
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              <li class="nav-header">Manage</li>
               <li class="active"><a href="/OTTS/ManageJSP/ManageTeacher.jsp">Teacher</a></li>
