        ...
        <div class="span2">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/OTTS/ManageJSP/ManageAdmin.jsp">Admin</a></li>
              <li><a href="/OTTS/ManageJSP/ManageTeacher.jsp">Teacher</a></li>
              <li><a href="/OTTS/ManageJSP/ManageSchool.jsp">School</a></li>
              <li><a href="/OTTS/ManageJSP/ManageStudent.jsp">Student</a></li>
              <li><a href="/OTTS/ManageJSP/ManageTest.jsp">Test</a></li>
              <li><a href="/OTTS/ManageJSP/ManageQuestion.jsp">Question</a></li>
              <li><a href="/OTTS/ManageJSP/ManageAward.jsp">Award</a></li>
              <li><a href="/OTTS/ManageJSP/ManageResult.jsp">Result</a></li>
              <li><a href="/OTTS/ManageJSP/ManageschoolAward.jsp">Allocate School Award</a></li>
             <li><a href="/OTTS/ManageJSP/ManagestudentAward.jsp">Allocate Student Award</a></li>
...
<div class="span6">
<h1>Welcome <%=session.getAttribute("name")%><br></h1>
<h3> Select a option from the left to perform the action</h3>
</div>
</div>
